...
public class TestHarness
{
    public static void main(String[] args) throws java.io.IOException {
        ...
        // create the bank
        //int tmpCustNum = 5;
        BankImpl theBank = new BankImpl(initialResources);
        ...
        try {
            ...
            //System.out.println(theBank.numberOfCustomers);
        ...
        while ( (requestLine = cl.readLine()) != null) {
            ...
            if (requestLine.equals("*"))
                ...
                //System.out.println("customer num "+custNum);
